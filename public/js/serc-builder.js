...
class SERCBuilder {
    ...
    constructor(target) {
        ...
        this.add_judge.onclick = (e) => {
            let newJudge = clazz.element.querySelector('[serc-builder-judge]').cloneNode(true)
            ...
            let mp = mps.querySelector('[serc-builder-marking-point]').cloneNode(true)
...
class SERCJudge {
    constructor(element, judges_list, deleted) {
        ...
        this.add_marking_point = element.querySelector('[serc-builder-marking-point-add]')

        this.marking_points = []

        this.marking_point_container = element.querySelector('[serc-builder-marking-points]');
        ...
        this.add_marking_point.onclick = (e) => {
            let newPoint = clazz.marking_point_container.querySelector('[serc-builder-marking-point]').cloneNode(true)
...
class SERCMarkingPoint {
    constructor(element, mp_list, deleted){
        ...
        this.weight = element.querySelector('[serc-builder-marking-point-weight]')
        this.delete = element.querySelector('[serc-builder-marking-point-delete]')
    ...
    toData() {
        ...
        if (this.description.value == "" || this.weight.value == "") return null
