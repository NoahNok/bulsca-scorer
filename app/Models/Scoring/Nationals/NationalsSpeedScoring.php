...
class NationalsSpeedScoring implements IScoring {
    ...
    public function getResults(IEvent $event): array
    {
       ...
       $results = DB::select($this->getResultQuery($event)); // ordered 
