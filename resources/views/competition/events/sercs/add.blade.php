...
@section('content')
    ...
    <div class="grid-3" serc-builder="builder" serc-builder-id="null" serc-builder-csrf="{{ csrf_token() }}"
        serc-builder-url="{{ route('comps.view.events.sercs.addPost', $comp) }}"
        serc-builder-after-url="{{ route('comps.view.events.sercs.view', [$comp, ':rep:']) }}">
