...
@section('content')
    ...
    <div class="flex flex-col  space-y-3" x-data="{
        ...
        <div>
            ...
            <input type="file" name="where" id="where" accept="image/*" placeholder="Where" style="display: none"
                x-ref="logo" @change="getLogoPreview($event.target.files[0])" required>
        </div>
        ...
        <div class="flex w-80 mt-2" @click="create">
            <x-loading-button class="se-btn-success w-full justify-center! ">Save</x-loading-button>
