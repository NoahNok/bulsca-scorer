...
@section('content')
    <h2 class="mb-0">Edit Result Scoring Schema</h2>
    ...
    <div class="flex flex-col space-y-4 " x-data="{
        ...
        save() {
            ...
            fetch('{{ route('orgs.scoring.result-schema.edit.post', [$org, $schema]) }}', {
                method: 'POST',
                headers: {
        ...
        init() {
            this.formula_data = {{ json_encode($schema->schema) }}
            this.formula_data.name = '{{ $schema->name }}'
