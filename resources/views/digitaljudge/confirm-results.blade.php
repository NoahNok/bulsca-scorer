...
<div class=" w-screen flex flex-col items-center mt-8 space-y-4 px-4 overflow-hidden ">
    ...
    <div class="flex flex-col space-y-4 items-center w-full ">
        ...
        <p>Below is a list of each team and their marks for each Judge and Marking Point. If there is a mistake you can click the edit button to jump to the respective edit page!</p>
