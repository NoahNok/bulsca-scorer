<div {{ $attributes->merge(['class' => 'se-modal']) }} x-cloak x-show="modals.{{ $id }}"
    ...
    <div @click.outside="closeModal" class="relative overflow-hidden" x-init="() => {
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-white/80 flex items-center justify-center" x-show="loading">
