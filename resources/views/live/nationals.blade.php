...
<body class="overflow-x-hidden  w-screen h-screen">
    ...
    <div class="w-full h-48 bg-rlss-blue flex flex-col justify-center px-12 "
    ...
    <div class="container mx-auto py-6">
        <h2 class="text-astoria text-rlss-blue font-extrabold">Event Order - Diving Pit Side</h2>
        ...
        <table class="table-auto font-greycliff">
            <thead>
                <tr class=" text-rlss-blue font-bold">
                    ...
                    <th class=" bg-rlss-blue bg-opacity-40 py-2 px-3 border border-rlss-blue w-48">Category</th>
            ...
            <tbody>
                @forelse ($heats->nth(2) as $key => $heat)
                    <tr>
                        <td class=" bg-rlss-blue text-white  text-center py-2 px-3 border border-rlss-blue ">
                            {{ $heat->first()->heat }}</td>
                        <td
        ...
        <br>
        <h2 class="text-astoria text-rlss-blue font-extrabold ">Event Order - Scoreboard Side </h2>
