                ...
                <table class=" table-fixed text-left ">
                    <thead class="border-b border-black">
                        ...
                        <tr>
                            ...
                            <th class=" w-12 text-center">Pens</th>
                            <th class=" w-12 text-center"></th>
                        ...
                        @for ($l = 1; $l <= $comp->max_lanes; $l++)
                            ...
                            @if ($lane)
                                <tr class="border-b border-black">
                                    ...
                                    <td>{{ $lane->club }} {{ $lane->team }}</td>
                                    <td class="border-x border-gray-300 border-l-black"></td>
                                    <td class="border-x border-gray-300"></td>
                                    <td class="border-x border-gray-300 border-r-black"></td>
