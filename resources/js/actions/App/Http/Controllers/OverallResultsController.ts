...
/**
* @see \App\Http\Controllers\OverallResultsController::view
...
/**
* @see \App\Http\Controllers\OverallResultsController::computeResults
* @see app/Http/Controllers/OverallResultsController.php:20
* @route '/comp/results/view-schema/{schema}'
*/
export const computeResults = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: computeResults.url(args, options),
    method: 'get',
})

computeResults.definition = {
    methods: ["get","head"],
...
* @route '/comp/results/view-schema/{schema}'
*/
computeResults.url = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { schema: args }
    }
    ...
    return computeResults.definition.url
            .replace('{schema}', parsedArgs.schema.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/comp/results/view-schema/{schema}'
*/
computeResults.get = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: computeResults.url(args, options),
    method: 'get',
})
...
* @route '/comp/results/view-schema/{schema}'
*/
computeResults.head = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: computeResults.url(args, options),
    method: 'head',
})

/**
* @see \App\Http\Controllers\OverallResultsController::viewForPrint
* @see app/Http/Controllers/OverallResultsController.php:55
* @route '/comp/results/view-schema/{schema}/print'
*/
export const viewForPrint = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: viewForPrint.url(args, options),
    method: 'get',
})

viewForPrint.definition = {
    methods: ["get","head"],
...
* @route '/comp/results/view-schema/{schema}/print'
*/
viewForPrint.url = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { schema: args }
    }
    ...
    return viewForPrint.definition.url
            .replace('{schema}', parsedArgs.schema.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/comp/results/view-schema/{schema}/print'
*/
viewForPrint.get = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: viewForPrint.url(args, options),
    method: 'get',
})
...
* @route '/comp/results/view-schema/{schema}/print'
*/
viewForPrint.head = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: viewForPrint.url(args, options),
    method: 'head',
})

/**
* @see \App\Http\Controllers\OverallResultsController::viewForPrintBasic
* @see app/Http/Controllers/OverallResultsController.php:47
* @route '/comp/results/view-schema/{schema}/print-basic'
*/
export const viewForPrintBasic = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: viewForPrintBasic.url(args, options),
    method: 'get',
})

viewForPrintBasic.definition = {
    methods: ["get","head"],
...
* @route '/comp/results/view-schema/{schema}/print-basic'
*/
viewForPrintBasic.url = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { schema: args }
    }
    ...
    return viewForPrintBasic.definition.url
            .replace('{schema}', parsedArgs.schema.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/comp/results/view-schema/{schema}/print-basic'
*/
viewForPrintBasic.get = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: viewForPrintBasic.url(args, options),
    method: 'get',
})
...
* @route '/comp/results/view-schema/{schema}/print-basic'
*/
viewForPrintBasic.head = (args: { schema: number | { id: number } } | [schema: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: viewForPrintBasic.url(args, options),
    method: 'head',
})

const OverallResultsController = { view, add, quickGen, publishToggle, provToggle, addPost, deleteMethod, hide, printAll, computeResults, viewForPrint, viewForPrintBasic, delete: deleteMethod }
