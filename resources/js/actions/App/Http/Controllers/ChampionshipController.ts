...
*/
export const view = (args: { organisation: number | { id: number } } | [organisation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/organisation/{organisation}/championships'
*/
view.url = (args: { organisation: number | { id: number } } | [organisation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
...
* @route '/organisation/{organisation}/championships'
*/
view.get = (args: { organisation: number | { id: number } } | [organisation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: view.url(args, options),
    method: 'get',
})
...
* @route '/organisation/{organisation}/championships'
*/
view.head = (args: { organisation: number | { id: number } } | [organisation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: view.url(args, options),
    method: 'head',
})
...
/**
* @see \App\Http\Controllers\ChampionshipController::show
* @see app/Http/Controllers/ChampionshipController.php:23
* @route '/organisation/{organisation}/championships/{championship}'
*/
export const show = (args: { organisation: number | { id: number }, championship: number | { id: number } } | [organisation: number | { id: number }, championship: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/organisation/{organisation}/championships/{championship}'
*/
show.url = (args: { organisation: number | { id: number }, championship: number | { id: number } } | [organisation: number | { id: number }, championship: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            organisation: args[0],
            championship: args[1],
...
* @route '/organisation/{organisation}/championships/{championship}'
*/
show.get = (args: { organisation: number | { id: number }, championship: number | { id: number } } | [organisation: number | { id: number }, championship: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
...
* @route '/organisation/{organisation}/championships/{championship}'
*/
show.head = (args: { organisation: number | { id: number }, championship: number | { id: number } } | [organisation: number | { id: number }, championship: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
...
const ChampionshipController = { view, create, store, show, addCompetition, associateCompetition, deassociateCompetition }
